...
export default function UserDashboard({ user }: { user: any }) {
  const stats = [
    ...
    { label: 'Trips Planned', value: '12', icon: Plane, color: 'text-primary-600', bg: 'bg-primary-100' },
      ...
      <div className="grid lg:grid-cols-[1fr_0.4fr] gap-10">
        <div className="space-y-6">
          <div className="flex items-center justify-between px-2">
            ...
            <button className="text-[11px] font-bold text-primary-600 uppercase tracking-widest hover:underline decoration-2 underline-offset-4">
              View All Alerts
            </button>
          </div>
          ...
          <div className="space-y-4">
             {[
               ...
               <div key={i} className="group bg-white p-6 rounded-[2rem] border border-slate-100 hover:border-primary-100/50 hover:shadow-lg transition-all flex items-center justify-between cursor-pointer">
                  <div className="flex items-center gap-6">
                     ...
                     <div>
                        ...
                        <div className="flex items-center gap-4">
                           ...
                           <p className="text-[11px] font-bold text-primary-600 uppercase tracking-widest">● {alert.status} Priority</p>
                        </div>
                     </div>
                  </div>
                  <div className="flex items-center gap-6">
        ...
        <div className="space-y-6">
          <div className="bg-slate-950 rounded-[3rem] p-8 text-white relative overflow-hidden group">
             ...
             <div className="relative z-10">
                ...
                <button className="w-full py-4 bg-white text-slate-950 rounded-2xl font-bold text-sm uppercase tracking-widest hover:bg-primary-50 transition-all">
                  New Model
                </button>
             </div>
          </div>
          ...
          {/* <div className="bg-white border border-slate-100 rounded-[3rem] p-8 space-y-6 shadow-sm">
             ...
             <div className="w-full h-2 bg-slate-50 rounded-full overflow-hidden">
                <div className="w-[60%] h-full bg-primary-600" />
             </div>
          </div> */}
        </div>
      </div>
